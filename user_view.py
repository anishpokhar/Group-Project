...
def admin_dashboard(user):
    ...
    tk.Button(admin_window, text="Logout", command=logout, fg="white", bg="red").pack(pady=10)
...
def student_dashboard(user):
    ...
    tk.Button(student_window, text="Logout", command=logout, fg="white", bg="red").pack(pady=10)
